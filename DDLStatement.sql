...
CREATE TABLE `reviews_directory` (
  ...
  KEY `FK_Reviewstorestaurant_idx` (`RESTAURANT_ID`),
  CONSTRAINT `FK_Reviewstorestaurant` FOREIGN KEY (`RESTAURANT_ID`) REFERENCES `restaurant` (`restaurant_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `FK_reviewstord` FOREIGN KEY (`REVIEW_ID`) REFERENCES `reviews_directory` (`review_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `menu_items` (
  ...
  CONSTRAINT `FK_MENU_ITEMS` FOREIGN KEY (`RESTAURANT_ID`) REFERENCES `restaurant` (`restaurant_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
